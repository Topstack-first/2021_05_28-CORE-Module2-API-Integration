...
namespace BeicipFranLabERP.Migrations
{
    ...
    partial class BecipDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.Backups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("Backup_Datetime")
                        .HasColumnType("datetime2");

                    b.Property<string>("FileSize")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Profile_Title")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.Destination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MigrationURL")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.SEIndex", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ContentStopwordToAdd")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ExportableListOfContentStopwords")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExportableListOfStopwords")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KeyWordMatching")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RecentPostBonusCutoff")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StopwordsToAdd")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.Schedules", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.Backups", b =>
                {
                    b.HasOne("BeicipFranLabERP.DAL.Model.Schedules", "Schedules")
                        .WithMany("Backups")
            ...
            modelBuilder.Entity("BeicipFranLabERP.DAL.Model.Schedules", b =>
                {
                    b.HasOne("BeicipFranLabERP.DAL.Model.Destination", "Destination")
                        .WithMany()
